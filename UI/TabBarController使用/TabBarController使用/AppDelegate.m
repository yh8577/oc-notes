...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    vc1.tabBarItem.image = [UIImage imageNamed:@"tabbar_discover"];
    
    ViewController1 *vc2 = [[ViewController1 alloc] init];
    vc2.view.backgroundColor = [UIColor blueColor];
    vc2.tabBarItem.title = @"vc2";
    vc2.tabBarItem.badgeValue = @"998";
    vc2.tabBarItem.image = [UIImage imageNamed:@"tabbar_home"];
    
    ViewController2 *vc3 = [[ViewController2 alloc] init];
    vc3.view.backgroundColor = [UIColor greenColor];
    vc3.tabBarItem.title = @"vc3";
    vc3.tabBarItem.badgeValue = @"998";
