...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation {
    ...
    // 封装大头针 View 和 cell的过程几乎一样,唯一不同对的地方是,可以不用设置模型属性
    MyAnnotationView *annoView = [MyAnnotationView annotationView:mapView];
    
    // 将模型属性放到这里,因为系统会自动调用 annotation 的 set 方法所以这里可以不用设置
